...
public class UpdateStageMoneyHandler(IStagesRepository repository, StagesEventBus eventBus) : IRequestHandler<UpdateStageMoneyRequest, UpdateStageMoneyResponse>
{
    public async Task<UpdateStageMoneyResponse> Handle(UpdateStageMoneyRequest request, CancellationToken cancellationToken)
    {
